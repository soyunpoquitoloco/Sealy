    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened() and i < 200:
            ...
            if results.pose_landmarks:
                ...
                cv2.putText(image, 'Look at the middle of the screen', (30, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
...
def main(cal_chin):
    ...
    try:
        while cap.isOpened():
            ...
            if posture_bad:
                count_posture += 1
                print("posture : "+str(count_posture))
            ...
            if distraction:
                count_distraction += 1
                print("distraction : "+str(count_distraction))
